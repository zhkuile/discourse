...
RSpec.describe "tasks/themes" do
  describe "themes:export_bundle" do
    let!(:theme) do
    ...
    it "exports a zip with theme, components, and manifest" do
      Dir.mktmpdir do |output_dir|
        ...
        capture_stdout { invoke_rake_task("themes:export_bundle", theme.id.to_s, output_path) }
    ...
    it "finds theme by name case-insensitively" do
      Dir.mktmpdir do |output_dir|
        ...
        capture_stdout { invoke_rake_task("themes:export_bundle", "my test theme", output_path) }
  ...
  describe "themes:import_bundle" do
    it "imports a theme bundle with components and settings" do
      ...
      Dir.mktmpdir do |output_dir|
        ...
        output = capture_stdout { invoke_rake_task("themes:import_bundle", output_path) }
